...
/**
  ...
  *
  */
class QuestionForm(question: Question) extends VerticalLayout {

  private val questionLabel = new Label(question.questionData.questionText)
  ...
  answersRadioButton.setItems(question.questionData.answers.asJava)
  question.answer.foreach(answer => answersRadioButton.setValue(answer))
